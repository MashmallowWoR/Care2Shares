...
class PaymentForm extends Component {
  ...
  render() {
    const { hostDisplayName, houseRules,houseRuleDescription, allowedPersonCapacity, paymentLoading, intl: { locale } } = this.props;
        ...
        <form onSubmit={handleSubmit(this.handleSubmit)}>
          <Row>
            <Col md={12} className={cx(s.textLeft, 'textAlignRightRtl')}>
              ...
              {
                (houseRules.length > 0 || houseRuleDescription) && <div className={s.space4}>
                  <HouseRules
                    hostDisplayName={hostDisplayName}
                    houseRules={houseRules}
                    houseRuleDescription={houseRuleDescription}
                  />
                </div>
              }
