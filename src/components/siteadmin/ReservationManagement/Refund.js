...
class Refund extends Component {
  ...
  handleClick() {
    ...
    let originalAmount = amount, fromCurrency = currency, refundAmount = amount;
    if (fromCurrency != toCurrency) refundAmount = convert(base, rates, amount, fromCurrency, toCurrency);
