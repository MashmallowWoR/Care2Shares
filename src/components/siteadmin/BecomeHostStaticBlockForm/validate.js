...
const validate = values => {
  ...
  } else if (values.blockContent1.length > 254) {
    errors.blockContent1 = messages.exceedLimit254
  }
  ...
  } else if (values.blockContent2.length > 254) {
    errors.blockContent2 = messages.exceedLimit254
  }
  ...
  } else if (values.blockContent3.length > 254) {
    errors.blockContent3 = messages.exceedLimit254
  }
