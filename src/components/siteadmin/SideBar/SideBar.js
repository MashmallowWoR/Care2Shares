                    ...
                    <div className={cx("hidden-print", s.sidebarNavParent)}>
                        ...
                        <li className={'visible-xs'}>
...

                            {
                              ...
                              {
                                validatePrivilege(19, privileges) && <li className={cx({ [s.active]: (location === "/siteadmin/managesearch" || location.startsWith('/siteadmin/managesearch')) })}>
                                    <Link to={'/siteadmin/managesearch'} className={cx(s.sideNavitem, s.disPlayTable)} onClick={() => this.openClose()}>
                                        <span className={s.disPlayTabelCell}>
                                            <FontAwesome.FaUser className={s.navigationIcon} />
                                        </span>
                                        <span className={s.disPlayTabelCell}><FormattedMessage {...messages.manageSearch} /></span>
                                    </Link>
                                </li>
                            }  
