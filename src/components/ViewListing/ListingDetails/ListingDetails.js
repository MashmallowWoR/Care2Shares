  ...
  render() {
    ...
    return (
      <Row className={cx(s.pageContent)}>
        ...
        {
          (houseRules.length > 0 || data && data.listingData && data.listingData.houseRuleDescription) && <div> <ListItem
            itemList={houseRules}
          ...
          />
            {
              <div>
                <span className={cx(s.subText, s.lineBreak)}>{data && data.listingData && data.listingData.houseRuleDescription}</span>
              </div>
            }
            <div>
              <hr />
